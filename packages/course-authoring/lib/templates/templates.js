...
exports.courseTemplates = [
    {
        ...
        description: 'A simple course template with introduction, content, and summary',
        blocks: [
            {
                id: '1',
                type: "text",
                content: { text: "Welcome to this course! We'll cover important concepts step by step." },
            },
            {
                id: '2',
                type: "text",
                content: { text: "By the end of this course, you'll have a solid understanding of the material." },
            }
        ],
        metadata: {
            category: 'General',
    ...
    },
    {
        ...
        blocks: [
            ...
            },
            {
                id: '4',
                type: "text",
                content: { text: "Watch the video above to get started with the course." },
            }
        ],
        metadata: {
