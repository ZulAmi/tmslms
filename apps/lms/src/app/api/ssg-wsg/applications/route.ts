...
import type { SSGWSGServices } from '../../../lib/ssg-wsg-integration';

// Submit funding application
export const POST = withSSGWSG(
  async (req: NextRequest, services: SSGWSGServices) => {
    try {
